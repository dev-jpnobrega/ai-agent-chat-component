...
patchBrowser().then(async (options) => {
  await globalScripts();
  return bootstrapLazy([["chat-component",[[1,"chat-component",{"greetings":[1],"identifier":[1],"chatUid":[1,"chat-uid"],"language":[1],"translations":[32],"messages":[32],"content":[32],"disableSend":[32]},[[0,"send","sendHandler"],[0,"receiver","receiverHandler"],[0,"keydown","handleKeyDown"]]]]],["my-component",[[1,"my-component",{"first":[1],"middle":[1],"last":[1]}]]]], options);
});
